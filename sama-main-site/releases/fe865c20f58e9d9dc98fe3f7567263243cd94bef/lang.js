(() => {
  ...
  const I18N = {
    tr: {
      ...
      about_kicker:'SAMA TRANSPORTS',about_title:'Güven, hız ve şeffaflık üzerine kurulu lojistik.',about_text:'Modern lojistik yaklaşımımız, saha deneyimimiz ve dijital operasyon altyapımızla müşterilerimize düzenli, takip edilebilir ve sürdürülebilir taşıma hizmetleri sunuyoruz.',about_point_1:'Operasyon odaklı planlama',about_point_2:'Şeffaf sevkiyat takibi',about_point_3:'Saha ile merkez arasında koordinasyon',
      ...
      contact_kicker:'İLETİŞİM',contact_title:'Bir sonraki taşımanızı birlikte planlayalım.',contact_text:'Taşımacılık ve lojistik ihtiyaçlarınız için SAMA Transports ekibiyle iletişime geçin.',contact_button:'E-posta Gönder',contact_note:'Kurumsal iletişim bilgileri bu alanda güncellenebilir.',footer_text:'© 2026 SAMA Transports. Tüm hakları saklıdır.'
    },
    en: {
      ...
      hero_eyebrow:'RELIABLE LOGISTICS SOLUTIONS',hero_title:'We move your cargo safely across borders.',hero_text:'From road transportation to port operations, SAMA Transports moves your cargo through a planned, transparent and traceable operation.',hero_contact:'Contact Our Team',hero_track:'ENTER SAMA TRACK',
      ...
      contact_kicker:'CONTACT',contact_title:'Let us plan your next shipment together.',contact_text:'Contact the SAMA Transports team for transportation and logistics requirements.',contact_button:'Send Email',contact_note:'Corporate contact details can be updated in this area.',footer_text:'© 2026 SAMA Transports. All rights reserved.'
    },
    ar: {
      ...
      hero_eyebrow:'حلول لوجستية موثوقة',hero_title:'ننقل شحناتكم بأمان عبر الحدود.',hero_text:'من النقل البري إلى عمليات الموانئ، تنقل SAMA Transports شحناتكم من خلال عمليات منظمة وشفافة وقابلة للتتبع.',hero_contact:'تواصل معنا',hero_track:'الدخول إلى SAMA TRACK',
      ...
      contact_kicker:'اتصل بنا',contact_title:'لنخطط شحنتك القادمة معاً.',contact_text:'تواصل مع فريق SAMA Transports لتلبية احتياجات النقل والخدمات اللوجستية.',contact_button:'إرسال بريد إلكتروني',contact_note:'يمكن تحديث معلومات الاتصال الرسمية في هذا القسم.',footer_text:'© 2026 SAMA Transports. جميع الحقوق محفوظة.'
    }
  };
