...
async def auth_middleware(request: Request, call_next):
    ...
    if not auth.startswith("Basic "):
        return Response(
            ...
            status_code=401,
            headers={"WWW-Authenticate": 'Basic realm="SAMA TRACK"'},
        )
...
<title>Çıkış Yapıldı - SAMA TRACK</title>
<style>
...
<main class="logout-wrap">
  <section class="logout-card">
    <div class="check">✓</div>
    <h1>Çıkış Yapılmıştır</h1>
    <p>Oturumunuz güvenli şekilde sonlandırıldı.</p>
    <p>SAMA TRACK sisteminden çıkış yaptınız.</p>

    <a class="login-btn" href="/">↪ Tekrar Giriş Yap</a>

    <div class="line"></div>
    <div class="footer">
      Güvenli yolculuklar dileriz.<br>
      <em>SAMA TRACK Ekibi</em>
    </div>
  </section>
</main>
</body>
