...
# Load the complete application/patch chain first, then attach final print/KolayBi/i18n/edit/login/security patches.
...
import login_visual_patch as login_visual
